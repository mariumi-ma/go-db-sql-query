...
func main() {
	...
	newClient := Client{
		FIO:      "Пушкин Александр Сергеевич", // укажите ФИО
		Login:    "СаняПушкин",                 // укажите логин
		Birthday: "17990606",                   // укажите день рождения
		Email:    "pushkin@yandex.ru",          // укажите почту
	}
	...
	newLogin := "СергеевичПушкин" // укажите новый логин
